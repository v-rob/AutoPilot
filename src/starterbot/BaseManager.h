...
private:
	...
	// The assumed maximum distance between resources in the same cluster, 8 tiles, in pixel units.
	const int RESOURCE_RADIUS = 8 * bw::TILEPOSITION_SCALE;
